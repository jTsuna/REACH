                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-left whitespace-nowrap">
                                        <button onclick="toggleElement('show{{ $user->id }}')"
                                            class="text-blue-600 hover:text-blue-900 focus:outline-none">Edit</button>
                                    </td>
                                </tr>
                                {{-- add meet link --}}
                                        ...
                                        <div
                                            ...
                                            <div class="px-4 pb-4 bg-white sm:p-6 sm:pb-4">
                                                ...
                                                <div class="flex items-center justify-center">
                                                    <h2 class="text-xl font-bold text-gray-900">Add Google Meet Link
                                                    </h2>
                                                </div>
                                                <div>
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        <div
                                                            class="w-full p-6 mt-4 border-4 border-yellow-500 rounded-lg">
                                                            <div class="py-2 ">
                                                                <x-jet-label for="link"
                                                                    value="{{ __('Google Meet Link') }}" />
                                                                <x-jet-input id="link"
                                                                    class="w-full p-2 border-2 border-yellow-400 appearance-none rounded-xl"
                                                                    type="text" name="link" required autofocus />
                                                            </div>
